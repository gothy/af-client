System.register([], function (_export) {
  var _get, _inherits, _classCallCheck, protocol, base_url, token, UPL_STATE_UPLOADING, UPL_STATE_PROCESSING, UPL_STATE_DONE, UPL_STATE_FAIL, ApiError, NetworkError, _doCheckUploadState, _doFileUpload, _itemMethodHelper, userLogin, userInfo, fileUpload, fileRename, fileDelete, fileCopy, fileMove, fileChangeMode, folderInfo, folderContent, folderCreate, folderRename, folderDelete, folderCopy, folderMove, folderChangeMode, trashcanContent, trashcanEmpty, trashcanRestore, remoteCreate, remoteDelete, remoteInfo, onetimeCreate, onetimeInfo, AFClient, except;
  ...
  return {
    ...
    execute: function () {
      ...
      base_url = "" + protocol + "://alfafile.net/api/v1";
      token = "";
      UPL_STATE_UPLOADING = 0;
      UPL_STATE_PROCESSING = 1;
      UPL_STATE_DONE = 2;
      UPL_STATE_FAIL = 3;
      ...
      _doCheckUploadState = function _doCheckUploadState(params, upload_id, cb) {
      ...
      _doFileUpload = function _doFileUpload(params, upload_url, cb) {
      ...
      _itemMethodHelper = function _itemMethodHelper(itype, method, params, response_field, cb) {
        params = params || {};
        params.token = params.token || token;
      ...
      userLogin = function userLogin(login, password, cb) {
      ...
      userInfo = function userInfo(cb) {
        return _itemMethodHelper("user", "info", {}, "user", cb);
      };

      fileUpload = function fileUpload(name, hash, size, file, options, cb) {
      ...
      fileRename = function fileRename(file_id, name, cb) {
        var params = {
          file_id: file_id,
          name: name
        };
      ...
      fileDelete = function fileDelete(file_id, cb) {
        var params = {
          file_id: file_id
        };
      ...
      fileCopy = function fileCopy(file_id, folder_id_dest, cb) {
        var params = {
          file_id: file_id,
      ...
      fileMove = function fileMove(file_id, folder_id_dest, cb) {
        var params = {
          file_id: file_id,
          folder_id_dest: folder_id_dest
        };
      ...
      fileChangeMode = function fileChangeMode(file_id, mode, cb) {
        var params = {
          file_id: file_id,
          mode: mode
        };
      ...
      folderInfo = function folderInfo(options, cb) {
        var args = Array.prototype.slice.call(arguments),
            params = {};
        cb = args.pop();
        if (args.length === 1) {
      ...
      folderContent = function folderContent(options, cb) {
        var args = Array.prototype.slice.call(arguments),
            params = {};
        cb = args.pop();
        if (args.length === 1) {
      ...
      folderCreate = function folderCreate(name, options, cb) {
        var args = Array.prototype.slice.call(arguments),
            params = { name: name };
      ...
      folderRename = function folderRename(folder_id, name, cb) {
        var params = {
          name: name,
          folder_id: folder_id
        };
      ...
      folderDelete = function folderDelete(folder_id, cb) {
        var params = {
          folder_id: folder_id
        };
      ...
      folderCopy = function folderCopy(folder_id, folder_id_dest, cb) {
        var params = {
          folder_id: folder_id,
          folder_id_dest: folder_id_dest
        };
      ...
      folderMove = function folderMove(folder_id, folder_id_dest, cb) {
        var params = {
          folder_id: folder_id,
          folder_id_dest: folder_id_dest
        };
      ...
      folderChangeMode = function folderChangeMode(folder_id, mode, cb) {
        var params = {
          folder_id: folder_id,
          mode: mode
        };
      ...
      trashcanContent = function trashcanContent(cb) {
        return _itemMethodHelper("trashcan", "content", {}, null, cb);
      };

      trashcanEmpty = function trashcanEmpty(options, cb) {
        var args = Array.prototype.slice.call(arguments),
            params = {};
      ...
      trashcanRestore = function trashcanRestore(options, cb) {
        var args = Array.prototype.slice.call(arguments),
            params = {};
      ...
      remoteCreate = function remoteCreate(url, options, cb) {
        var args = Array.prototype.slice.call(arguments),
            params = {};
      ...
      remoteDelete = function remoteDelete(job_id, cb) {
        var params = {
          job_id: job_id
        };
      ...
      remoteInfo = function remoteInfo(options, cb) {
        var args = Array.prototype.slice.call(arguments),
            params = {};
      ...
      onetimeCreate = function onetimeCreate(file_id, options, cb) {
        var args = Array.prototype.slice.call(arguments),
            params = {};
      ...
      onetimeInfo = function onetimeInfo(options, cb) {
        var args = Array.prototype.slice.call(arguments),
            params = {};
        cb = args.pop();
        if (args.length === 1) {
      ...
      except = ["_setToken", "_setBaseUrl", "ApiError", "NetworkError"];
